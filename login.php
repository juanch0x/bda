		...
		<div class="extra2 container">
			<div class="ebox1">
				...
				<div class="title">
					...
					<form action="valida_login.php" name="formulario" method="POST" onsubmit="return validarContrasena();">
						<input type="email" name="email" placeholder="Em@il" />	<br />
						<input type="password" name="password" placeholder="Contraseña" id="password" /><br />
						<br /><input type="submit" name="enviar" class="button" value="Ingresar!" />
					</form>
