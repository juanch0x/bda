...
<title>Editar empresa de distribucion!</title>
	...
	<div id="featured-wrapper">
		...
		<div class="extra2 container">
			<div class="ebox1">
				...
				<div class="title">
					<h2>Editar Empresa de Distribucion</h2>
...
<?php 
	...
	$id_empresa_distr = $_GET['id_empresa_distr'];
			...
			<form action="update_empresa.php" method="POST">
				...
				<tr><td>Empresa de Distribucion</td><td> <input type="text" name="empresa_distr" value="<?php echo $array_empresa['empresa_distr'];?>" /></td></tr>
