...
<div id="wrapper">
	<div id="featured-wrapper">
		...
		<div class="extra2 container">
			<div class="ebox1">
				...
				<div class="title">
					...
					return confirm('¿Estas seguro de eliminar el genero?'); 
					} </script>
		...
		<center>
			<table>
			<form action="delete_genero.php" method="POST" onsubmit="return pregunta();">
				<tr><td>ID</td><td> <input type="text" name="id_genero" disabled value="<?php echo $id_genero;?>" /></td></tr>
				<tr><td>Genero</td><td> <input type="text" name="genero" disabled value="<?php echo $array_genero['genero'];?>" /></td></tr>
				<input type="text" name="genero" hidden value="<?php echo $array_genero['genero'];?>"/>
