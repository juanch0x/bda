...
<title>Busca el eliminar para editar!</title>
		...
		<div class="extra2 container">
			<div class="ebox1">
				...
				<div class="title">
					...
					<span class="byline">Para eliminar el juego simplemente haz click en la imagen del mismo</span>
					<br /><br /><br />
				...
				<?php 
						...
						if(isset($_GET['busqueda'])){
							...
							while ($array_busqueda = mysql_fetch_array($result)) {
								...
								echo "<tr><td><a href='borrar_juego_form.php?id=".$array_busqueda['id_juegos']."'><img src='../../image/portada/".$array_busqueda['id_juegos'].".jpg'/></a></td></tr>";
	}
