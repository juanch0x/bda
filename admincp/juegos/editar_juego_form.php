		 ...
		 ?>
			...
			<center>
				<table>	
					...
					<form action="editar_juego_procesar.php" method="POST" enctype="multipart/form-data">
						...
						<tr><td>Titulo</td><td><input type="text" name="titulo" value="<?php echo $array_juego['titulo'] ?>" /></td></tr>
						<!--<tr><td>Imagen</td><td><input type="file" id="archivo" name="archivo" /></td></tr>-->
						<tr><td>Trailer</td><td><input type="text" name="trailer" value="<?php echo $array_juego['trailer'] ?>" /></td></tr>
						<tr><td>Fecha de Lanzamiento</td><td><input type="DATE" name="fecha" value="<?php echo $array_juego['fecha_lanzamiento'] ?>" /></td></tr>
						<tr><td>Edad Mínima</td><td><input type="text" name="edad" value="<?php echo $array_juego['edad_minima'] ?>" /></td></tr>		
						<tr><td>Precio</td><td><input type="text" name="precio" value="<?php echo $array_juego['precio'] ?>" /></td></tr>
						<tr><td>Plataforma</td><td><input type="text" name="plataforma" value="<?php echo $array_juego['plataforma'] ?>" /></td></tr>
						...
						<tr><td>Reseña</td><td><textarea name="resena" cols="22" rows="8"><?php echo $array_juego['resena'] ?></textarea></td></tr>
