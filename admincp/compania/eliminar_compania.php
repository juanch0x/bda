...
<div id="wrapper">
	<div id="featured-wrapper">
		...
		<div class="extra2 container">
			<div class="ebox1">
				...
				<div class="title">
					...
					return confirm('¿Estas seguro de eliminar la compañìa?'); 
					} </script>
		...
		<center>
			<table>
			<form action="delete_compania.php" method="POST" onsubmit="return pregunta();">
				<tr><td>ID</td><td> <input type="text" name="id_compania" disabled value="<?php echo $id_compania;?>" /></td></tr>
				<tr><td>Compañía</td><td> <input type="text" name="compania" disabled value="<?php echo $array_compania['compania'];?>" /></td></tr>
				<input type="text" name="compania" hidden value="<?php echo $array_compania['compania'];?>"/>
